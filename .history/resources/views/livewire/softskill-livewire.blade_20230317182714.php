<div class="flex flex-col gap-2">
    ...
    <form class="mt-3 flex flex-col items-center gap-3 w-full" wire:submit.prevent="save({{$this->softskillId}})">
    ...
    <div class="rounded bg-gray-100 p-4 dark:bg-zinc-900">
        ...
        <hr>
        <ul class="flex flex-col lg:grid lg:grid-cols-2 gap-4 p-2 w-full">
