<nav x-data="{ open: false }" class="bg-white dark:bg-zinc-800 border-b border-zinc-100 dark:border-zinc-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <x-application-logo class="w-12 block h-9 fill-current text-zinc-800 dark:text-zinc-200" />
                    </a>
                </div>

                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('portfolio')" target="_blank">
                        {{ __('Portfolio') }}
                    </x-nav-link>
                ...
                <x-dropdown-nav align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            ...
                            <div class="ml-1">
                                <svg class="fill-zinc-900 dark:fill-white h-4 w-4" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 20 20">
            ...
            <!-- Hamburger -->
            <div class="mr-8 flex items-center sm:hidden">
                <button @click="open = ! open"
                    ...
                    <svg class="h-6 w-6 stroke-zinc-900 dark:stroke-white" viewBox="0 0 24 24">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('portfolio')" target="_blank">
                {{ __('Portfolio') }}
