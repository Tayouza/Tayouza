<svg version="1.1" xmlns="http://www.w3.org/2000/svg" {{$attributes}}  class="skill-icon" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
  ...
  <g>
    ...
    <ellipse transform="matrix(-0.1254 -0.9921 0.9921 -0.1254 8.9754 38.9969)" fill="#212121" cx="21.7" cy="15.5"
      rx="1.2" ry="0.7" />
