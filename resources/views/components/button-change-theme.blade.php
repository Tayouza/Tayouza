<div class="p-1"
    ...
    <button type="button" aria-label="Alternar tema" x-on:click="toggle()"
        ...
        <svg x-show="!dark" x-cloak class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
